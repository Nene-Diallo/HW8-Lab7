...
Group: Nene Diall, Arifa Begum, Leonardo Alcaide, Maria Camilia Vergas, Sun Wo Kim
...
load("/Users/nene/Desktop/Econometrics/ACS_2021_couples.RData")
...
```{r Question 2}
1.Ekundayo et al. (2023) on Open Data Implementation and Entrepreneurship in Sub-Saharan Africa https://onlinelibrary.wiley.com/doi/10.1155/2023/7583550  

Ekundayo et al. investigate how open data implementation influences entrepreneurial abilities across 22 sub-Saharan African countries, using data from the Open Data Barometer and Global Entrepreneurship Index. Their regression analysis reveals a non-significant negative relationship, suggesting that improved open data infrastructure may be needed to foster entrepreneurship in the region

  
2. Herrington & Coduras (2019) on Entrepreneurship Conditions in Sub-Saharan Africa. https://ideas.repec.org/a/spr/jglont/v9y2019i1d10.1186_s40497-019-0183-1.html

Herrington and Coduras analyze barriers to entrepreneurship in South Africa, Angola, Mozambique, and Madagascar using Global Entrepreneurship Monitor data from National Expert Surveys. They identify lack of finance, government support, and entrepreneurship education as major obstacles, limiting entrepreneurial growth in these sub-Saharan nations.
